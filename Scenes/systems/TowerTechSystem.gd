...
func can_unlock_tower_tech(tower_type: String, tech_id: String) -> bool:
	...
	var parent = tech_data.get("parent", "")
...
func is_tower_tech_unlocked(tower_type: String, tech_id: String) -> bool:
	return tower_tech_progress.get(tower_type, {}).get(tech_id, false)
...
func apply_tech_bonuses_to_tower(tower: Turret):
...
func get_tower_max_gem_level(tower_type: String) -> int:
	...
	var tech_data = Data.tower_tech_tree[tower_type].get(specialization, {})
	return tech_data.get("gem_slot_level", 1)
...
func get_tech_point_system() -> TechPointSystem:
